                ...
                <div className="container">
                    <div className="w-full mt-10">
                        <div className="flex gap-3 justify-end">
                            <Link to={'/modal-create'} className="text-sm bg-gradient px-4 uppercase font-light tracking-widest py-2 rounded-lg shadow-lg shadow-indigo-600 text-white"><PlusOutlined /> Add Modal</Link>
