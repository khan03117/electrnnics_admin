                    ...
                    <div className="grid grid-cols-4 gap-5">
                        ...
                        <div className="col-span-2">
                            ...
                            <div className="flex">
                                ...
                                <button type='button' onClick={postdata} title='button' className="text-sm bg-gradient px-4 uppercase font-light tracking-widest text-nowrap py-2 rounded-none shadow-lg shadow-indigo-600 text-white inline-block"><SaveOutlined /> Save Variant</button>
                            </div>
